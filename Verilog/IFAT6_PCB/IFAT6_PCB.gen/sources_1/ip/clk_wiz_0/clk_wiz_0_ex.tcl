#-------------------------------------------------------------
# Generated Example Tcl script for IP 'clk_wiz_0' (xilinx.com:ip:clk_wiz:6.0)
#-------------------------------------------------------------
...
set srcIpDir "c:/Users/jains/OneDrive - UC San Diego/research/IFAT6/IFAT6_PCB/Verilog/IFAT6_PCB/IFAT6_PCB.gen/sources_1/ip/clk_wiz_0"

# Declare xci file location
set srcXciDir "c:/Users/jains/OneDrive - UC San Diego/research/IFAT6/IFAT6_PCB/Verilog/IFAT6_PCB/IFAT6_PCB.srcs/sources_1/ip/clk_wiz_0"

# Create project
puts "INFO: \[open_example_project\] Creating new example project..."
create_project -name clk_wiz_0_ex -force
...
set_property ip_repo_paths [list c:/Users/jains/OneDrive - UC San Diego/research/Opal Kelly/FrontPanel-Vivado-IP-Dist-v1.0.5] [current_project]
update_ip_catalog
...
import_ip -files [list [file join $srcIpDir ../../../../IFAT6_PCB.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xci]] -name clk_wiz_0
if { $returnCode == 0 } { 
  reset_target {open_example} [get_ips clk_wiz_0]
  ...
  generate_target [_filter_supported_targets {instantiation_template synthesis simulation implementation shared_logic} [get_ips clk_wiz_0]] [get_ips clk_wiz_0]
} 
...
if { $returnCode == 0 } { 
  ...
  [list [file join $srcIpDir clk_wiz_0/example_design/clk_wiz_0_exdes.v]]
} 
...
if { $returnCode == 0 } { 
  ...
  [list [file join $srcIpDir clk_wiz_0/example_design/clk_wiz_0_exdes.xdc]]
...
if { $returnCode == 0 } { 
  ...
  [list [file join $srcIpDir clk_wiz_0/simulation/clk_wiz_0_tb.v]]
set_property USED_IN_SYNTHESIS false [get_files [list [file join $importDir clk_wiz_0_tb.v]]]
} 
...
if { $returnCode == 0 } { 
  ...
  if { [catch {current_fileset -simset} exc] } { create_fileset -simset sim_1 }
  add_files -quiet -copy_to $importDir -fileset [current_fileset -simset] \
  [list [file join $srcIpDir config_v.txt]]
} 
