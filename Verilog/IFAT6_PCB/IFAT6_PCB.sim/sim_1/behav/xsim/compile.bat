...
REM
REM Generated by Vivado on Tue Sep 19 14:59:12 -0700 2023
...
echo "xvlog --incr --relax -prj dac_tb_vlog.prj"
call xvlog  --incr --relax -prj dac_tb_vlog.prj -log xvlog.log
