...
#
# Generated by export_simulation on Mon Oct 03 21:31:35 PDT 2022
#
################################################################################
...
'-reset_run' switch to the './leds_ifat6.sh' script.

./leds_ifat6.sh -reset_run
...
./leds_ifat6.sh -noclean_files

For more information on the script, please type './leds_ifat6.sh -help'.
