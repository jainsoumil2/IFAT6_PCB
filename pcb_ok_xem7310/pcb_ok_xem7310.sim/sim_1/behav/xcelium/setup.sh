...
create_lib_mappings()
{
  ...
  touch $file
  lib_map_path="/Volumes/export/isn/soumil/Xilinx/ifat6/pcb_ok_xem7310/pcb_ok_xem7310.cache/compile_simlib/xcelium"
...
# Script info
echo -e "setup.sh - Script generated by launch_simulation (Vivado v2022.1 (64-bit)-id)\n"
