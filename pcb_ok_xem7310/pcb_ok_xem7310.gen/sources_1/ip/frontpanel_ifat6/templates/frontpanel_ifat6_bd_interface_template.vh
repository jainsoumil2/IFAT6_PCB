...
//----------------------------------------------------------------------------------------------------------------------------------
    ...
    (* X_INTERFACE_INFO = "opalkelly.com:interface:wirein:1.0 wirein0d_DESCRIPTION EP_DATAOUT" *)
    input  wire [31:0] wi0d_ep_dataout_DESCRIPTION,
...
//----------------------------------------------------------------------------------------------------------------------------------
    ...
    (* X_INTERFACE_INFO = "opalkelly.com:interface:wireout:1.0 wireout25_DESCRIPTION EP_DATAIN" *)
    output wire [31:0] wo25_ep_datain_DESCRIPTION,
